...
NoOfCall_bucket → Service call threshold analysis

intl_charge_bucket → Pricing sensitivity analysis
...
Customers with 4+ service calls → 50% churn

International plan users → 42% churn

Heavy daytime users churn due to higher charges (bill shock)

Voice mail users churn less → value-added features improve retention
...
Offer usage-based calling plans
